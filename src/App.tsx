  ...
  return (
    <LanguageProvider>
      <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
        ...
        {appState === 'questions' && <AssessmentQuestions formData={formData!} onBack={() => setAppState('form')} onComplete={(id) => { setSubmissionId(id); setAppState('result'); }} />}
        {appState === 'result' && <AssessmentResult submissionId={submissionId!} onBack={() => { setFormData(undefined); setAppState('landing'); }} />}
      </div>
    </LanguageProvider>
  );
}
